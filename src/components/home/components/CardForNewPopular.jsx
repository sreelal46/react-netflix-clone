...
export default function Card({ title, gap, show }) {
  ...
  useEffect(() => {
    tmdb
      .get(`/${show}?api_key=${API_key}&language=en-US&page=1`)
      .then((res) => {
  ...
  return (
    <div
      className="container absolute mt-20 top-20 px-12 "
      style={{ top: `${gap}px` }}
    >
